...
class Player1326State:
    ...
    def currentBet(self) -> Bet:
        ...
        In Python, the superclass method should return ``NotImplemented``. This is a big debugging
        aid, it helps us locate subclasses which did not provide a method body.
        """
...
class Player1326ThreeWins(Player1326State):
    ...
    def currentBet(self) -> Bet:
        """
        Constructs a new :py:class:`~bet.Bet` from the player’s :py:class:`~outcome.Outcome`
        information. The bet multiplier is 6.
        """
    ...
    def nextWon(self) -> Player1326NoWins:
        """
        Constructs the new :class:`Player1326NoWins` instance to be used when the bet was a winner.
        """
